...
%filToLoad = ['h20_004G1-1.f32'];
%filToLoad = ['h22_001bG1-1.f32'];% same rec
filToLoad = ['h23_004bG1-1.f32'];

%filToLoad = ['h20_001aG1-1.f32'];% same rec
%filToLoad = ['h20_001bG1-1.f32'];% same rec
%filToLoad = ['h20_001cG1-1.f32'];% same rec



%filToLoad = ['h22_001aG1-1.f32'];% same rec


%filToLoad = ['h22_023G1-1.f32'];
%filToLoad = ['h22_027G1-1.f32'];

%filToLoad = ['h23_001bG1-1.f32'];
...
dropBoxSavePath = [fiGSavePath saveName '-SpatialRFstest'];
