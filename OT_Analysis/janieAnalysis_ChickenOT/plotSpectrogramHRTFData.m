...
[yupperL,~] = envelope(LData);
[yupperR,~] = envelope(RData);
...
saveName = [FigSaveDir 'StimFigure'];
plotpos = [0 0 20 15];

%plot2svg
%plot2svg(saveName, figH)

print_in_A4(0, saveName, '-djpeg', 1, plotpos); % res type needs to be 1 or it takes forever
