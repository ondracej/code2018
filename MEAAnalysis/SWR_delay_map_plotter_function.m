...
function [] = SWR_delay_map_plotter_function(file_add, swrInds)
...
figSaveDir = [filepath '\DetectionPlots\'];
...
if isempty(channelsNotToInclude)
    chansNotToPlot = data.D.channelsNotToInclude;
else
    chansNotToPlot = channelsNotToInclude;
end
