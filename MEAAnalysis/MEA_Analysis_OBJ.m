classdef MEA_Analysis_OBJ < handle
    ...
    methods
        ...
        function obj = getPathInfo(obj,analysisDir)
            ...
            obj.PATH.spikeAnalysis = [analysisDir 'spike_Analysis' dirD];
            obj.PATH.dirD  = dirD ;
        ...
        function obj = load_MCS_data_detectSWRs(obj, fileToLoad, ChannelsToNoTIncludeInDetections)
            dbstop if error
            ...
            swrAnalysisDetections_plotDir = [obj.PATH.swrAnalysis name obj.PATH.dirD];
...
figure(100);clf
    ...
    pause
            ...
            save([saveDir name '-RippleData.mat'], 'SWR_INFO', '-v7.3')
