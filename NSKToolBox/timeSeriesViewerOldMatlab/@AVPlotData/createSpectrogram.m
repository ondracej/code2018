...
obj.hPlotControls.plotPropGrid=uiextras.Grid('Parent', obj.hControlPanel, 'Padding', 10, 'Spacing', 10);
...
set(obj.hPlotControls.plotPropGrid, 'ColumnSizes',[-1 -1],'RowSizes', [30 30 30 30 30] );
