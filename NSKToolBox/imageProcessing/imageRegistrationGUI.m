classdef imageRegistrationGUI < handle
    ...
    methods
        function obj=imageRegistrationGUI() %class constructor
            ...
            obj.par.trasformNames={'similarity','nonreflective similarity','projective','polynomial','piecewise linear','lwm'};
            obj.par.trasformMinPoints=[3 2 4 10 4 6];
            obj.par.transformStrings={'similarity (3)','nonref. similarity (2)','projective (4)','3rd deg. polynomial (10)','piecewise linear (4)','lwm (6,better=12)'};
        ...
        function createGUI(obj)
            ...
            obj.h.calculateListTransform=uicontrol('Parent', obj.h.transformControlVBox, 'Style','push', 'String','Calculate all list trans.','Callback',@obj.CalculateListTransformPushCallback);
            obj.h.calculateSelectedListTransform=uicontrol('Parent', obj.h.transformControlVBox, 'Style','push', 'String','Calculate selected list trans.','Callback',@obj.CalculateSelectedListTranformCallback);
    ...
    methods (Access=protected)
        ...
        function LoadLayoutPushCallback(obj,hObj,event,imageNum)
            ...
            [meshX,meshY]=meshgrid(1:size(obj.par.layout,1),1:size(obj.par.layout,2));
