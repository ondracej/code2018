...
fontColor='w'; %Scale bar font color
...
if transparentScale
    if scaleBarOutsideAxis
        ...
        hScaleBar(1,1)=patch(PX,PY,edgeC,'FaceColor',scaleBarColor,'EdgeColor','none','FaceAlpha',scaleBarTransparancy,'Parent',hAxis,'Clipping','off');
    end
else
