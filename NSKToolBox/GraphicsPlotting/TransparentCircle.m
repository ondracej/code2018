...
function h=TransparentCircle(X,Y,R,C,transparency,NPoints,varargin)
...
h=patch(PX,PY,C,'EdgeColor','none','FaceAlpha',transparency,'FaceColor','flat','FaceVertexCData',C,varargin{:});