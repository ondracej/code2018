    ...
    methods
        ...
        function obj=run(obj)
            ...
            if obj.interTrialDelay==0
                ...
                wait2NextFrame=obj.actualStimDuration;
            else
            ...
            Screen('DrawTexture',obj.PTB_win,obj.imgTex(obj.imgSequence(obj.order(1))),[],obj.visualFieldRect,obj.rotation);
            ...
            for i=1:obj.nTotTrials
                ...
                elseif i<obj.nTotTrials
                    ...
                    [obj.on_Flip(i+1),obj.on_Stim(i+1),obj.on_FlipEnd(i+1),obj.on_Miss(i+1)]=Screen('Flip',obj.PTB_win,obj.on_Flip(i)+obj.actualStimDuration-0.5*obj.ifi);
                    obj.sendTTL(2,false); %session start trigger (also triggers the recording start)
                    obj.off_Flip(i+1)=obj.on_Flip(i+1);
                end
                % Update image buffer for the next trial
                Screen('DrawTexture',obj.PTB_win,obj.imgTex(obj.imgSequence(obj.order(i+1))),[],obj.visualFieldRect,obj.rotation);
                obj.applyBackgound;  %set background mask and finalize drawing (drawing finished)
        ...
        function obj=calculateImageTextures(obj,event,metaProp)
            ...
            for i=1:nImages
                ...
                if N>=M
                    ...
                    obj.imgTex(i)=Screen('MakeTexture', obj.PTB_win,I(:,(cutPixels+1):(end-cutPixels),:),obj.rotation);
                else
