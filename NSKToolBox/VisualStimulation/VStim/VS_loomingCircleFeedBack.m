classdef VS_loomingCircleFeedBack < VStim
    ...
    methods
        function obj=run(obj)
            ...
            ch=obj.daqSession.addAnalogInputChannel('Dev2', {'ai0','ai1','ai2'}, 'Voltage');
            ...
            ch(2).Range=[-5 5];
            ch(3).Range=[-5 5];
            obj.daqSession.DurationInSeconds=10; %sec
            obj.daqSession.IsContinuous=false;
            obj.daqSession.Rate=5000; %Hz
            ...
            obj.daqSession.DurationInSeconds=obj.CSDuration+movementDuration+1; %sec
            ...
            for i=1:obj.nTotTrials
                ...
                Screen('Flip',obj.PTB_win);
                ttmp=t+tStartSession+obj.ifi+obj.CSDuration;
                frameTTL=false;
                obj.sendTTL(2,true);
                for j=1:nFrames
                    % Update display
