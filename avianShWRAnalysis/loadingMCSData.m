...
dataDir = '/media/janie/My Passport/JohannaData/20210407/Output/';
plotDir = '/media/janie/My Passport/JohannasDataFigs/20210407/';
textSearch = ['*.h5*'];
h5Files=dir(fullfile(dataDir,textSearch));

for j = 1:numel(h5Files)
    thisFile{j} =  h5Files(j).name;
end

for o = 1:numel(h5Files)
    
    fileToLoad  = [dataDir  thisFile{o}];
