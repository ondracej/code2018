...
rootZ = 'D:\TUM\SWR-Project\ZF-71-76\20190915\20-01-48\dat'; % the raw data binary file is in this folder
...
chanMapFile = 'linear2Chans.mat';

%%
ops.trange = [0 Inf]; % time range to sort
%ops.NchanTOT    = 16; % total number of channels in your recording
ops.NchanTOT    = 2; % total number of channels in your recording

run(fullfile(pathToYourConfigFile, 'StandardConfig_JO_2Chan.m'))
