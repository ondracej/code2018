function [] = batchPlotDataForOpenEphys_inputFromDatabase()
dbstop if error
close all
        ...
        for s=chanSet
            ...
            if doPlot
                ...
                if plotMulti
                    ...
                    % High Pass
                    hold on
                    plot(SegData_s, DataSeg_rect_HF - Plotting.hpRectOffset, 'r'); % mean subtracted
                    plot(SegData_s, DataSeg_HF + offsetHP); % *10 to magnify it
