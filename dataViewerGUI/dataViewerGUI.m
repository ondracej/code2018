...
classdef dataViewerGUI < handle
    ...
    methods
        function obj = dataViewerGUI(parent)
...
%             end
        ...
        function build(obj, f)
            ...
            obj.H.settings.setProbeEdt = uicontrol('Parent', obj.H.settingsGrid,'Style', 'popupmenu', 'HorizontalAlignment', 'left', 'String', probeNames, 'Callback', @(~,~)obj.updateProbeView('reset'));
            obj.H.settings.setnChanEdt = uicontrol('Parent', obj.H.settingsGrid,'Style', 'edit', 'HorizontalAlignment', 'left','String', '', 'Callback', @(~,~)obj.updateFileSettings());
            obj.H.settings.setFsEdt = uicontrol('Parent', obj.H.settingsGrid,'Style', 'edit', 'HorizontalAlignment', 'left','String', '30000', 'Callback', @(~,~)obj.updateFileSettings());            
            
            obj.H.settings.setTrangeEdt = uicontrol('Parent', obj.H.settingsGrid,'Style', 'edit', 'HorizontalAlignment', 'left', 'String', '');
            obj.H.settings.setMinfrEdt = uicontrol('Parent', obj.H.settingsGrid,'Style', 'edit', 'HorizontalAlignment', 'left','String', '');
            obj.H.settings.setThEdt = uicontrol('Parent', obj.H.settingsGrid,'Style', 'edit', 'HorizontalAlignment', 'left','String', '');
            obj.H.settings.setLambdaEdt = uicontrol('Parent', obj.H.settingsGrid,'Style', 'edit', 'HorizontalAlignment', 'left','String', '');
            obj.H.settings.setCcsplitEdt = uicontrol('Parent', obj.H.settingsGrid,'Style', 'edit', 'HorizontalAlignment', 'left', 'String', '');
...
%                 'Callback', @(~,~)obj.saveGUIsettings());
            ...
            % -- Data view
            %obj.H.dataVBox = uiextras.VBox('Parent', obj.H.dataPanel, 'Padding', 20);
            obj.H.dataVBox = uiextras.VBox('Parent', obj.H.dataPanel, 'Padding', 2); % JO
